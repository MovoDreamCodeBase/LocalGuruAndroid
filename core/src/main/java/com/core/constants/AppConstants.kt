...
object AppConstants {
    const val STATUS_REVISION_NEEDED = "Revision Needed"
    const val STATUS_NOT_STARTED = "Not Started"
    const val STATUS_HIGH_PRIORITY = "High Priority"
...
//    const val DYNAMIC_DATA_SET = "LocalGuruDynamicFieldsData"//UAT
    const val DYNAMIC_DATA_SET = "LocalGuruDynamicFieldsData202"//Live
